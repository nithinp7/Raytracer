...
public:
	...
	/*  Functions  */
	// constructor
	Mesh(vector<VertexModel> vertices, vector<unsigned int> indices, vector<Texture> textures)
	{
...
private:
	...
	void setupMesh()
	{
		...
		glBufferData(GL_ARRAY_BUFFER, vertices.size() * sizeof(VertexModel), &vertices[0], GL_STATIC_DRAW);
